...
<body>
    <div class="main-container text-center error-404 not-found">
        <div class="container">
            <h1 class="title-404" style="color: green">✔</h1>
            <h1 class="title">Đặt hàng thành công!</h1>
            <p class="subtitle">Chúng tôi sẽ liên lạc và kiểm tra đơn hàng giao tới bạn.
            </p>
            <!-- .page-content -->
            <a href="{{route('return_route_FrontEnd_Home')}}" class="button" style="border-radius:20px; background-color:#C92127 !important;">Quay về trang đơn hàng</a>
        </div>
    </div>
