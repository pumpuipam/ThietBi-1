...
<style>
    ...
    <div class="main-container shop-page left-sidebar" style="padding-top: 140px">
        <div class="container bg-white shadow" style="border-radius:10px;">
            <div class="row">
                <div class="container">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group has-success mb-2">
                                            ...
                                            <input class="form-control @error('password') is-invalid @enderror"
                                                ...
                                                padding-top: 6px;
                                            ">
                                            <span class="input-group-text bg-white" onclick="myFunction3()" 
                                            style=" border-top-right-radius:20px;
                                            border-bottom-right-radius:20px;"> <img
                            ...
                            <div class="row mt-0" style="margin-top:10px;">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group" style="width:100%;">
                                        ...
                                        padding-top: 6px;
                                    ">
                                            <span class="input-group-text bg-white" onclick="myFunction1()"
                                            style=" border-top-right-radius:20px;
                                            border-bottom-right-radius:20px;"> <img
                                                    src="{{ Storage::url('customers/icons8-eye-64.png') }}"
                                                    style="width: 20px;height: 20px;"></span>
                                    ...
                                    <div class="form-group mb-0" style="width:100%;">
                                        <div class="input-group has-success mb-2">
                                            ...
                                            <input class="form-control  @error('password') is-invalid @enderror"
                                                ...
                                                style="    padding-bottom: 6px;
                                        padding-top: 6px; ">
                                            <span class="input-group-text bg-white" onclick="myFunction2()" style=" border-top-right-radius:20px;
                                            border-bottom-right-radius:20px;"> <img
                                                    src="{{ Storage::url('customers/icons8-eye-64.png') }}"
                                                    style="width: 20px;height: 20px;"></span>
                                        </div>
                            ...
                            <div class="row mt-0 mt-3 mb-4 " style="margin-top:10px;">
                                <div class="col-md-12">
                                    <button type="submit" onclick="postPassword()"
                                        class="btn btn-lg btn-lg w-100 mt-4 mb-4"
                                        ...
                                        ";>
                                        <p style="font-size:14px; margin-bottom:0px;">Thay đổi mật khẩu</p>
                                    </button>
                                </div>
                            </div>
            ...
            if (value != '') {
                if (value_1 != value_2) {
                    ...
                    $.ajax({
                        ...
                        processData: false,
                        cache: false,
                        url: '{{ route('user.checkChangePassword') }}',
                        method: 'POST',
                        data: formData,
