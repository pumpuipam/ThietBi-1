                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-4">Thêm thể loại sản phẩm</h4>
                                ...
                                <form id="frm1" class="custom-validation" action="" method="post"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" class="form-control" rows="2">{{ old('description', isset($request['description']) ? $request['description'] : '') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-0">
                                        <div class="text-end">
                                            ...
                                            <a href="{{ route('route_BackEnd_Type_Product_List') }}"
