                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-4">Cập nhật phiếu xuất</h4>

                                <form id="frm1" class="custom-validation" action="{{ route('inventory_export.update') }}" method="post"
                                                        ...
                                                        @endphp
                                                            <tr  id="tr_{{ $key+1 }}">
                                                                ...
                                                                <td class="text-center">
                                                                    <button type="button" onclick="RemoveProduct(this)" style="border:none; background:none;" @if($inventory->status == 2) disabled @endif><i class="text-danger fa-solid fa-trash"></i></button>
                                                                </td>    
                                    ...
                                    <div class="mb-0">
                                        <div class="text-end">
                                            ...
                                            @endif
                                            <a href="{{ route('inventory_export.index') }}"
