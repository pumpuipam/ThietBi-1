                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h4 class="card-title">Danh sách xuất kho</h4>
                                    <a href="{{ route('inventory_export.create') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td class=" text-center ">
                                                    ...
                                                    @if(auth()->user()->role_id === 1)
                                                        ...
                                                        <a class="btn btn-success" href="{{ route('inventory_export.argee',$Pro->id) }}">Duyệt phiếu xuất</a>
                                                        <a class="btn btn-danger" href="{{ route('inventory_export.delete',$Pro->id) }}"><i class="fa-solid fa-trash"></i></a>
                                                    @endif
                                                        <a class="btn btn-info"  href="{{ route('inventory_export.edit',$Pro->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                    @else
