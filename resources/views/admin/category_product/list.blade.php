                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h4 class="card-title">Danh sách nhóm sản phẩm</h4>
                                    <a href="{{ route('route_BackEnd_Category_Product_Create') }}"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-centered table-nowrap table-striped mb-0">
                                        ...
                                        <tbody>
                                            @forelse ($categoryProduct as $cate)
                                                <tr>
                                                    <th scope="row" class="text-primary">{{ 'CA000' . $cate->id }}</th>
                                                    <td>
                                                        {{ $cate->name }}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a href="{{ route('route_BackEnd_Category_Product_Edit', $cate->id) }}"
                                                                class="btn btn-primary btn-sm">Chỉnh sửa</a>
                                                                {{-- <a href="{{ route('route_BackEnd_Category_Product_Delete', $cate->id) }}"
