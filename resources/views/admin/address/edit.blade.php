                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="frm1" class="custom-validation" action="{{ route('address.update') }}" method="post"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Chọn tỉnh <span
                                        ...
                                        <select  class="form-select" name="provinceid" id="provinceid" onchange="ChooseProvinces()">
                                            ...
                                            @foreach($provinces as $province)
                                                @if($province->provinceid == $add->provinceid)
                                                    <option value="{{ $province->provinceid }}" selected>{{ $province->type }} - {{ $province->name }}</option>
                                                @else
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Chọn huyện/thị trấn <span
                                                class="text-danger">*</span></label>
                                        <select  class="form-select" name="cityid" id="cityid" onchange="ChooseWardid()">
                                            <option selected value=""> - - - Chọn huyện - - - </option>
                                            @foreach($districts as $dis)
                                                @if($dis->districtid == $add->cityid)
                                                    <option value="{{ $dis->districtid }}" selected>{{ $dis->type }} - {{ $dis->name }}</option>
                                                @else
                                                    <option value="{{ $dis->districtid }}">{{ $dis->type }} - {{ $dis->name }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                        @error('type_id')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="wardid" id="wardid" >
                                            ...
                                            @foreach($ward as $war)
                                                ...
                                                @if($war->wardid == (int)$add->wardid)
                                                    <option value="{{ $war->warid }}" selected>{{ $war->type }} - {{ $war->name }}</option>
                                                @else
                                                    <option value="{{ $war->warid }}">{{ $war->type }} - {{ $war->name }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                        @error('type_id')
