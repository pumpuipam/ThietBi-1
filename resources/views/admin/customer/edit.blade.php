                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="custom-validation"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Mật khẩu <span class="text-danger">* ( Mật khẩu mặc định 000000 )</span></label>
                                        <div>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Số nhà
                                        </label>
                                        <div>
                                            <input data-parsley-type="number" name="apartment_number" type="text"
                                                class="form-control" value="{{ $customer->apartment_number }}">
                                        
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Địa chỉ cá nhân

                                        </label>
                                        <div>
                                            <input data-parsley-type="number" name="address" type="text"
